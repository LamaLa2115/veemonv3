...
client.on("guildCreate", guild => {
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .addField(`**Invite veemon**`, `[Invite Here](https://discord.com/api/oauth2/authorize?client_id=868297144480710756&permissions=8&scope=bot)`, true)
    .addField(`**Upvote veemon**`, `[Upvote Here](https://top.gg/bot/868297144480710756)`, true)
