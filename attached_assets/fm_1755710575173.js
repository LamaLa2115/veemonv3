...
You can connect your **Last.fm** using \`${prefix2}lastfm set <username>\``
        ...
        var options = {
            uri: "http://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=" + fmUser + "&api_key=dc0b1c5a3c0dd588558700c484ec5a20&format=json&extended=1",
            headers: {
        ...
        rp(options)
            .then(function (lastfm) {
                ...
                var trackURL = "http://ws.audioscrobbler.com/2.0/?method=track.getInfo&username=" + fmUser + "&api_key=dc0b1c5a3c0dd588558700c484ec5a20&artist=" + artistName + "&track=" + trackName + "&format=json&autocorrect=1";
                var options2 = {
                    uri: trackURL,
                    headers: {
                        'Connection': 'keep-alive',
                ...
                rp(options2)
                    .then(function (track) {
                        ...
                        let cover = "";
                        let album = "";
                        const result = request.get(`http://ws.audioscrobbler.com/2.0/?method=user.getRecentTracks&user=${fmUser}&api_key=dc0b1c5a3c0dd588558700c484ec5a20&format=json&limit=1`)
                        result.then(res => {
